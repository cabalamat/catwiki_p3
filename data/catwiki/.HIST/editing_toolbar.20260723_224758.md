...
## Multi-line tools: <i class='fa fa-quote-left'></i> <i class='fa fa-list-ul'></i> <i class='fa fa-list-ol'></i> <tt class='mono_tool'>mono</tt> <mark>mark</mark> <i class='fa fa-paragraph'></i>1-para
...
<i class='fa fa-paragraph'></i>1-para | `a\n\nb` | `a b` | makes selection one paragraph
