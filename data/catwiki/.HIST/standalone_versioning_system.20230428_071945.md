...
Consider whe re we have a wiki page `fred` in folder `foo`. This will be stored as `fred.md` in directory `foo`. The user edits this file. the file `foo/fred.md` is changed. This is ow Catwiki currently works
